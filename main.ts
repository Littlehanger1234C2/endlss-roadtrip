...
function _ (speed: number, num: number, x: number, y: number) {
        ...
        if (!(Splash)) {
            ...
            for (let Index = 0; Index <= 4; Index++) {
                if (Index == RandomNumber) {
                    _(Car.vx * 0.333, randint(SlowCarHonks, SlowCarHonks + 3), 11, Index + 2)
                } else {
                    _(Car.vx * 0.333, randint(SlowCarHonks + 4, SlowCarHonks + 14), 11, Index + 2)
                }
            }
